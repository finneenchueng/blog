<template>
  <div class="weui-panel weui-panel_access post-form" ref="post_form">
        ...
        <div class="weui-panel__bd">
            <div class="weui-media-box weui-media-box_text">
                ...
                <div class="weui-cells weui-cells_form">
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="weui-cell__bd">
                            <input class="weui-input" type="text"  name="title" placeholder="请输入标题" v-model="postData.title" />
                        </div>
                    </div>
                    <div class="weui-cell">
                        ...
                        <div class="weui-cell__bd">
                          <select class="weui-select" name="type" v-model="postData.type">
                            <option  v-for="(item,index) in catelist" :value="item.cateId" :selected="item.cateId==postData.type?'selected':''">{{item.cateName}}</option>
                          </select>
                        </div>
                    </div>
                    <div class="weui-cell weui-cell_switch">
                        ...
                        <div class="weui-cell__ft">
                            <input class="weui-switch" :class="checkBoxCls" type="checkbox" name="enabled" v-model="postData.enabled"/>
                        </div>
                    </div>
                    <div class="weui-cell weui-cell_switch">
                        <div class="weui-cell__bd">是否允许评论</div>
                        <div class="weui-cell__ft">
                            <input class="weui-switch" :class="checkBoxCls" type="checkbox" name="allowComment" v-model="postData.allowComment"/>
                        </div>
                    </div>
                    <div class="weui-cell weui-cell_switch">
                        <div class="weui-cell__bd">是否允许匿名评论</div>
                        <div class="weui-cell__ft">
                            <input class="weui-switch" :class="checkBoxCls" type="checkbox" name="forbidAnonymousComment" v-model="postData.forbidAnonymousComment"/>
                        </div>
                    </div>
                    <div class="weui-cell">
                        <div class="weui-cell__hd"><label class="weui-label">预览内容</label></div>
                        <div class="weui-cell__bd">
                            <textarea class="weui-textarea" name="summary" :value="summay" placeholder="请输入文本" rows="3" :maxlength="summayOpt.sum" @blur="chgSummary"></textarea>
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="weui-cell__bd">
                            <input class="weui-input" type="text"   name="lblName" v-model="postData.lblName"  placeholder="请输入标签"/>
                        </div>
                    </div>
                    <div class="weui-cell">
                        <div class="weui-cell__hd"><label class="weui-label">搜索词</label></div>
                        <div class="weui-cell__bd">
                            <input class="weui-input" type="text" name="keyWords" v-model="postData.keyWords" placeholder="请输入搜索词"/>
                        </div>
                    </div>
                </div>
                ...
                <p class="weui-media-box__desc editor-box" style="height:630px">
                  <html5Editor :content="decodeContent(postData.content)"   @change="updateContentData" ref="editor_box"></html5Editor>
                </p>
            </div>
        ...
        <modal :show.sync="modalOpt.show"  :closeWhenOK.sync="!modalOpt.show" :extendClass="modalOpt.cancelClass" :full="modalOpt.fullModal" @ok="modalConfirm" :title="modalOpt.title" >
        ...
        <div class="weui-panel__ft">
            ...
            <div class="weui-form-preview__ft">
                <a class="weui-form-preview__btn weui-form-preview__btn_default" href="javascript:" @click="postPreview">预览</a>
                <button type="submit" class="weui-form-preview__btn weui-form-preview__btn_primary" href="javascript:" @click="submitPosts">确定</button>
            </div>
        </div>
