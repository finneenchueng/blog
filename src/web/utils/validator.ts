...
//         // const flag = value.identityCodeValid();
//         const flag = false;
//         return {
//             flag,
//             message: '身份证号码格式不正确'
//         }
// }
// export function minLength(value: string, param: any){
//     const flag = value.length >= param[0];
//     return {
//         flag,
//         message: '请输入至少{0}个字符.'
//     }
// }
// export function maxLength(value: string, param: any){
//     const flag = value.length < param[0];
//     return {
//         flag,
//         message: '请输入最长{0}个字符.'
//     }
// }
// export function length(value: string, param: any){
//     const flag = value.length < param[0];
//     return {
//         flag,
//         message: '请输入最长{0}个字符.'
...
// }
//     maxLength: {
//         validator: function (value: string, param: any) {
...
//     equalTo: {
//         validator: function (value: string, param: any) {
//             const input_ele: HTMLInputElement = document.querySelector("#" + param) as HTMLInputElement;
//             const v_input = input_ele.value;
