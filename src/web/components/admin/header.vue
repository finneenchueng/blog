<template>
    <div class="weui-navbar">
        ...
        <div class="weui-navbar__item menu-item" v-for="(item,index) in menu_list"
             :class="{'weui-bar__item_on': (m_index==index)}">
            <a href="javascript:void(0)" :data-index="index" @click="doJump"><i class="fa"
                                                                                :class="item.iconclsName"></i>{{item.text}}</a>
